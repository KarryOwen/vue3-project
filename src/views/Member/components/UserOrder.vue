...
const getOderList = async () => {
  const rel = await getUserOrder(params.value)
  orderList.value = rel.result.items
  total.value = rel.result.counts
}

onMounted(() => getOderList())
          ...
          <div class="order-item" v-for="order in orderList" :key="order.id">
            ...
            <div class="body">
              ...
              <div class="column state">
                <p>{{ tabTypes[order.orderState-1].label }}</p>
